...
vim.keymap.set("i", "<A-h>", "<cmd>bprevious<cr>", { desc = "Previous buffer" })
vim.keymap.set("i", "<A-l>", "<cmd>bnext<cr>", { desc = "Next buffer" })
...
vim.keymap.set({ "i", "n", "s", "x" }, "<C-s>", "<cmd>w<cr><esc>", { desc = "Save current buffer" })
