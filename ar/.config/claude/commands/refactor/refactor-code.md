...
3. **WRITE** the plan to a report file: `public/reports/refactor/refactor_[target]_DD-MM-YYYY_HHMMSS.md`
...
2. **Directory**: `public/reports/refactor/` (create if it doesn't exist)
...
Reference this document when implementing: @public/reports/refactor/refactor\_[target]\_DD-MM-YYYY_HHMMSS.md_
...
public/reports/refactor/refactor\_[target_file_name]\_DD-MM-YYYY_HHMMSS.md

```

Example: `public/reports/refactor/refactor_mcp_server_14-07-2025_143022.md`
...
3. Write the plan to: `public/reports/refactor/refactor_[target]_DD-MM-YYYY_HHMMSS.md`
